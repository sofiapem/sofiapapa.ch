...
$(document).ready(function(){
  ...
  $('.index').on("click", "a", function(){ // info
 
        var toLoad = $(this).attr('href')+' #Main'; 
        // là où on définit la variable de la chose à charger 
        // #content: filtre les éléments
        
        console.log('target: '+toLoad); // message pour la console (on peut l'enlever, utilise)
